...
/**
 * This tests the four distance base cases (IT DOES NOT TEST PointTriangle and EdgeEdge as those become one of the four base cases
 * and generating test cases for the decision tree is hard (I'm lazy)) against random test cases in 'tests.txt' generated by the 
 * python script 'generate_tests.py' which uses sympy to symbolically differentiate random the distances for random positions and
 * prints the output to the text file.
 *  
 * Also tests the mapping helper functions which map the indices of lower dimensional base cases to the higher dimensional case
 */
...
TEST_CASE("Map Gradient") {
	cout << "Running: Map Gradient" << endl;
